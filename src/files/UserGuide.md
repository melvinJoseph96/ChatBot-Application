...
## A user can be recommended a team for the email to be sent to

First you need to say to the chatbot that you want to send an email. The chatbot will respond with a button for every team you can send an email to and a "I do not know" button. Click on the "I do not know" button, then the chatbot will display a message saying "Please, write briefly the reason you want to email us about:". Type into the text box the reason you want to send an email (ex. What jobs are available?) and then the chatbot will create an empty email, ready for you to write, to the relevant team.
