...
//    }
//
//    private void addResponse(String id, String newResponse) {
...
//    }
//
//    private void addUserSays(String id, String newUserSays) {
//        ArrayList<Intent> intents = getIntents();
//        Intent intent = intents.stream().filter(x -> x.getId().equals(id)).findAny().orElse(null);
//        if (intent != null) {
//            String intentName = intent.getName();
...
//        test.addResponse("8a043471-028d-4645-af0a-55a698385337", "numbegfsdgfsr 7");
//        test.addUserSays("8a043471-028d-4645-af0a-55a698385337", "nubedfgsdfgsdr 5");
//    }
